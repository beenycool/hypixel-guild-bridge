...
`config`: Generated directory made by the application during its runtime. Local runtime files and backups are saved there. Dynamic configuration and runtime state are stored in PostgreSQL.  
